...
class EpistaticModelManager(models.Manager):
    ...
    def create_epistatic_model(self, parameter, software, run_number, snp_id,
        ...
        epistatic_model = self.create(parameter=parameter, software=software, run_number=run_number,
...
class EpistaticModel(models.Model):
    ...
    class Meta:
        unique_together = ('parameter', 'software', 'run_number', 'locus_span', 'snp_id', 'multiplier')
